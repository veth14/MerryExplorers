    ...
    <section id="admissions" className="relative py-16 sm:py-24">
      ...
      <div className="relative mx-auto w-full max-w-6xl px-5 sm:px-8">
        <m.div
          ...
          style={{ background: "linear-gradient(135deg, #0033A0 0%, #002080 100%)" }}
        >
          <div aria-hidden className="pointer-events-none absolute left-1/2 top-8 text-2xl opacity-80 text-[#FFC107]">✦</div>
          ...
          <div className="relative grid items-center gap-14 lg:grid-cols-2">
            ...
            >
              <div className="relative flex h-56 w-56 items-center justify-center rounded-3xl bg-white shadow-2xl sm:h-72 sm:w-72">
                <svg className="h-28 w-28 text-[#0033A0]" viewBox="0 0 48 48" fill="none">
            ...
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              >
                <Link
                  href="/inquire"
                  id="inquire-now-btn"
                  className="group inline-flex items-center gap-2 rounded-full bg-[#FFC107] px-8 py-3.5 text-[15px] font-bold text-[#0b1a3d] shadow-lg transition-all duration-300 hover:bg-[#FFB800] hover:-translate-y-0.5"
                >
                  Inquire Now
