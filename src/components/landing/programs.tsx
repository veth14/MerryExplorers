          ...
          {activeTab === "trailblazer" && (
            ...
            >
              ...
              <m.article
                ...
                className="relative mb-8 flex flex-col rounded-[2.5rem] bg-white/80 backdrop-blur-2xl border border-white shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_24px_80px_-10px_rgba(26,46,107,0.12)] transition-all duration-300 hover:-translate-y-2"
              >
                {/* Header */}
                <div className="relative px-6 pb-7 pt-12 text-center rounded-t-[2.5rem]" style={{ backgroundColor: BRAVE_EXPLORER.bgTop }}>
                  {/* Single Centered Emoji Icon */}
                  <div className="absolute left-1/2 -top-7 -translate-x-1/2 flex h-14 w-14 items-center justify-center">
                    {BRAVE_EXPLORER.icon === "magnifying_glass" && <EmojiMagnifyingGlass className="h-14 w-14" />}
                    {BRAVE_EXPLORER.icon === "palette" && <EmojiPalette className="h-14 w-14" />}
                    {BRAVE_EXPLORER.icon === "lightbulb" && <EmojiLightbulb className="h-14 w-14" />}
                    {BRAVE_EXPLORER.icon === "rainbow" && <EmojiRainbow className="h-14 w-14" />}
                  </div>
