...
export function SiteHeader() {
  ...
  return (
    <m.header
      ...
      className="fixed top-0 inset-x-0 z-50 px-4 pt-4 md:pt-6 pointer-events-none"
    >
      <m.div 
        animate={{ 
        ...
        className="pointer-events-auto mx-auto flex h-[76px] w-full max-w-[1200px] items-center justify-between rounded-full px-5 pr-4 sm:px-8 sm:pr-5 backdrop-blur-2xl border border-white/80"
      >
        
        {/* ── Logo ── */}
        <Link href="/" className="flex items-center gap-3 shrink-0 group">
          <div className="relative h-11 w-11 overflow-hidden transition-transform duration-300 group-hover:scale-105 group-hover:-rotate-3">
            <Image src="/LOGO-noBG.png" alt="Merry Explorers Logo" fill sizes="44px" className="object-contain" priority />
          </div>
          <span className="flex flex-col leading-none">
            <span className="font-headline text-[19px] font-extrabold tracking-tight text-[#0033A0]">Merry</span>
            <span className="font-headline text-[12px] font-bold tracking-[0.14em] text-[#FFB800]">Explorers</span>
          </span>
        </Link>
        ...
        <div className="flex items-center md:hidden">
          <button
            ...
            aria-expanded={open}
            className="flex h-11 w-11 items-center justify-center rounded-full bg-[#f4f7fc] text-[#0033A0] transition-colors hover:bg-[#eaf0fe]"
          >
        ...
        {open && (
          <div className="md:hidden pointer-events-auto">
            ...
            <m.div
              ...
              className="fixed inset-0 top-[90px] z-40 bg-[#0b1a3d]/30 backdrop-blur-md"
            ...
            <m.div
              ...
              className="absolute inset-x-4 top-[92px] z-50 rounded-[2rem] bg-white/95 backdrop-blur-2xl p-3 shadow-[0_32px_80px_-15px_rgba(0,51,160,0.3)] border border-[#eaf0fe]"
            >
