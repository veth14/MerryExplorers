    ...
    <div className="flex h-full flex-col">
      ...
      <div className="p-3 mb-2">
        <div className="relative">
          ...
          >
            {/* Admin Dashboard for Executive Partners */}
            {(userProfile?.role || "").toLowerCase() === "executive partner" && (
              <>
                <Link
                  href="/admin"
                  onClick={() => { setUserMenuOpen(false); onClose?.(); }}
                  className="flex items-center gap-3 px-4 py-3 text-[13px] font-bold text-[#ffb800] hover:bg-[#ffb800]/10 transition-colors"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
