            ...
            <div className="space-y-2">
              ...
              >
                <span className={pathname === "/admin" ? "text-white" : "text-[#005cc8]"}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><rect x="3" y="3" width="7" height="7" rx="1.5" /><rect x="14" y="3" width="7" height="7" rx="1.5" opacity={0.7} /><rect x="3" y="14" width="7" height="7" rx="1.5" opacity={0.7} /><rect x="14" y="14" width="7" height="7" rx="1.5" opacity={0.7} /></svg>
                </span>
                <span>Dashboard</span>
              </Link>
              ...
              {[
                {
                  ...
                  items: [
                    ...
                    { label: "Payroll", href: "/admin/payroll", icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5"><rect x="2" y="5" width="20" height="14" rx="2" /><line x1="2" y1="10" x2="22" y2="10" /><path d="M7 15h.01" /><path d="M11 15h2" /></svg> },
                  ]
                },
                {
                ...
                },
                {
                  title: "Operations",
                  items: [
                    { label: "Inquiries", href: "/admin/inquiries", icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg> },
                    { label: "Reports", href: "/admin/reports", icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5"><path d="M3 3v18h18" /><path d="M18 9l-5 5-4-4-6 6" /></svg> },
                    ...
                    { label: "Audit Log", href: "/admin/audit-log", icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /><polyline points="10 9 9 9 8 9" /></svg> },
                  ]
                }
              ].map((group) => {
                      ...
                      <div className="space-y-1 pl-2 border-l-2 border-[#005cc8]/10 ml-4">
                        {group.items.map((item) => {
                          ...
                          return (
                            ...
                            >
                              <span className={isActive ? "text-white" : "text-[#005cc8] scale-90"}>{item.icon}</span>
                              <span>{item.label}</span>
                            </Link>
                          );
                        })}
